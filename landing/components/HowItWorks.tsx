const steps = [
  {
    num: '01',
    title: 'Point your AI tools to TokenGate',
    desc: 'Set two environment variables. That\'s it. No code changes, no SDK, no new config files.',
    code: true,
  },
  {
    num: '02',
    title: 'Use Claude Code as normal',
    desc: 'Nothing changes in your workflow. Same commands, same editor, same speed.',
    code: false,
  },
  {
    num: '03',
    title: 'TokenGate tracks + enforces your policies',
    desc: 'See usage in real time. Get alerts. Hit budget caps before your bill does.',
    code: false,
  },
]
    ...
    <section id="how-it-works" aria-labelledby="hiw-heading" className="py-20 sm:py-24 bg-gray-950 text-white">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <ol className="space-y-10">
          {steps.map((step) => (
            <li key={step.num} className="grid sm:grid-cols-[64px_1fr] gap-5 items-start">
              <div
                aria-hidden="true"
                className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-sm font-bold text-blue-400"
              >
                {step.num}
              </div>
              <div>
