...
type PlanLimits struct {
	...
	// MaxBudgetLimits is the maximum number of budget (spend) limits.
	// -1 means unlimited.
	MaxBudgetLimits int `json:"max_budget_limits"`
	// MaxRateLimits is the maximum number of rate limit rules.
	// -1 means unlimited.
	MaxRateLimits int `json:"max_rate_limits"`
	// MaxNotificationChannels is the maximum number of notification channels.
	// -1 means unlimited.
